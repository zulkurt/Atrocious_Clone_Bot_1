...
from bot.modules.helper_funcs.mirror_helpers.message_utils import sendMessage, sendMarkup, deleteMessage, delete_all_messages, update_all_messages, sendStatusMessage
from bot.modules.helper_funcs.mirror_helpers.filters import CustomFilters
from bot.modules.helper_funcs.mirror_helpers.clone_status import CloneStatus
from bot.modules.helper_funcs.mirror_helpers.bot_utils import *
from bot.modules.helper_funcs.mirror_helpers.direct_link_generator import *
from bot.modules.helper_funcs.mirror_helpers.exceptions import DirectDownloadLinkException
...
def _clone(message, bot, multi=0):
    ...
    if is_gdrive_link(link):
        ...
        sendMessage("Send Gdrive or GDToT, HubDrive, KatDrive, Filepress Link along with command or by replying to the link by command", bot, message)
